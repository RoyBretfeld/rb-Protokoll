...
*Regel: Mockdaten sind riesengroßer Mist und verstecken Fehler.*
- **Pflicht**: Nutze echte Daten oder extrem nah an der Realität liegende API-Antworten/Strukturen.
- **Pflicht**: Keine hartcodierten "Test-Werte" in der produktiven Geschäftslogik.
- **Ziel**: Das Interface gegen Grenzwerte realer Daten testen.
