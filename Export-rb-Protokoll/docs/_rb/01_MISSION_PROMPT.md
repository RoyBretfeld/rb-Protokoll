...
```powershell
python .agent/skills/rb_police/scripts/rb_tag_check.py --all --slice "Slice-N: Name"
```

#### Bei CRITIC PASS → Sentinel-Bestätigung (manuell):
Checke die 5 Gesetze (Details: `.agent/skills/tag/SKILL.md`). Dann:
```powershell
...
> Vollständige Rollendefinitionen: `.agent/skills/tag/SKILL.md`
...
- [§5 Hard-Fail Runtime](.agent/skills/rb_police/scripts/hard_fail.py)
- [Pre-Commit Police](.agent/skills/rb_police/scripts/pre_commit_police.py)
